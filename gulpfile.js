...
const less = require("gulp-less");//compiler code styles to css
const sourcepams = require('gulp-sourcemaps');//record source code scripts or sass to map
const concat = require('gulp-concat');//file concatenation into one
const uglify = require('gulp-uglify');//scripts code minimization
...
const  bable = require('gulp-babel');//compiler scripts ES6 into ES5
